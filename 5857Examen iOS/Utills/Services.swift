...
public class Services{
    public func request<ResponseType: Codable, ParamsObject: Decodable & Encodable>(_ url:String, method: HTTPMethod, params: ParamsObject, model: ResponseType.Type, handler: @escaping (_ request: ResponseType?, _ error: NSError?) -> Void){
